...
class Dulyart_API {
    ...
    public function __construct() {
        ...
        // add ajax interface: http://dulyart.co.il/wp-admin/admin-ajax.php?action=get_video_gallery&lang=he
    ...
    function email_wp(){
        ...
        $to = "rodion@emyoli.com";
        $subject = "Email from API DulyArt";
        /*
        $content.= "Name:".$data['name']."\n";
        $content.= "Email:".$data['email']."\n";
        $content.= "Group:".$data['group']."\n";
    ...
    $images = get_posts(array('post_type' => 'gg_galleries', 'posts_per_page' => -1, 'suppress_filters'=>1));
        ...
        //http://dulyart.co.il/wp-admin/admin-ajax.php?action=get_image_gallery&lang=he&per_page=10&page=2
        ...
        if(isset($_REQUEST['per_page'])) { $per_page = $_REQUEST['per_page'];
        } else {$per_page = 10;}
